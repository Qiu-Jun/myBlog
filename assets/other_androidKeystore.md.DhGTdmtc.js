import{_ as s,o as i,c as a,a6 as n}from"./chunks/framework.Bna9RZrE.js";const o=JSON.parse('{"title":"Android证书生成","description":"","frontmatter":{"title":"Android证书生成","date":"2022-05-21 17:26:59","sidebar":false,"categories":["其他"],"tags":["Android","其他"],"publish":true},"headers":[],"relativePath":"other/androidKeystore.md","filePath":"other/androidKeystore.md","lastUpdated":1728663095000}'),l={name:"other/androidKeystore.md"},t=n(`<div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># testalias是证书别名，可修改为自己想设置的字符，建议使用英文字母和数字</span></span>
