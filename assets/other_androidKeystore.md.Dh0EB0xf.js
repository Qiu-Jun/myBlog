import{_ as i,c as a,o as n,a5 as l}from"./chunks/framework.PZKd_Vnq.js";const d=JSON.parse('{"title":"Android证书生成","description":"","frontmatter":{"title":"Android证书生成","date":"2022-05-21 17:26:59","sidebar":false,"categories":["其他"],"tags":["Android","其他"],"publish":true},"headers":[],"relativePath":"other/androidKeystore.md","filePath":"other/androidKeystore.md","lastUpdated":1742135743000}'),t={name:"other/androidKeystore.md"};function p(e,s,h,k,r,A){return n(),a("div",{"data-pagefind-body":!0},s[0]||(s[0]=[l(`<div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># testalias是证书别名，可修改为自己想设置的字符，建议使用英文字母和数字</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Enter keystore password:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入证书文件密码，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Re-enter new password:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   //再次输入证书文件密码，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># What is your first and last name?  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [Unknown]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入名字和姓氏，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># What is the name of your organizational unit?  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [Unknown]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入组织单位名称，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># What is the name of your organization?  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [Unknown]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入组织名称，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># What is the name of your City or Locality?  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [Unknown]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入城市或区域名称，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># What is the name of your State or Province?  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [Unknown]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入省/市/自治区名称，输入完成回车  </span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [Unknown]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //输入国家/地区代号（两个字母），中国为CN，输入完成回车  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Is CN=XX, OU=XX, O=XX, L=XX, ST=XX, C=XX correct?  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   [no]:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //确认上面输入的内容是否正确，输入y，回车  </span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Enter key password for &lt;testalias&gt;  </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># (RETURN if same as keystore password):</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  //确认证书密码与证书文件密码一样（HBuilder|HBuilderX要求这两个密码一致），直接回车就可以</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 控制台说明</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Enter keystore password:</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> //输入密码，回车</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 注意</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># jdk13没有md5,只有sha1和sha256,我更换了jdk8</span></span></code></pre></div>`,1)]))}const y=i(t,[["render",p]]);export{d as __pageData,y as default};
