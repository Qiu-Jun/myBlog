 ...
 */
// html2canvas 源码，源码不支持文字渐变，这是修改后的代码
          ...
          text.textBounds.forEach(function (text) {
            ...
            paintOrder.forEach(function (paintOrderLayer) {
              ...
              switch (paintOrderLayer) {
                case 0 /* FILL */:
                  console.log("paintOrderLayer 0:", paintOrderLayer);
                  if (styles.backgroundClip[0] == 3) {
                    if (styles.backgroundImage[0] === undefined) {
                      _this.ctx.fillStyle = asString(styles.backgroundColor);
                    } else {
                      (_b = calculateGradientDirection(
                  ...
                  break;
                case 1 /* STROKE */:
                  console.log("paintOrderLayer 1:", paintOrderLayer);
            ...
            case 14:
              ...
              if (isTextInputElement(container) && container.value.length) {
                (_b = this.createFontStyle(styles)),
                  (fontFamily = _b[0]),
                  (fontSize = _b[1]);
                baseline = this.fontMetrics.getMetrics(fontFamily, fontSize)
                  .baseline;
